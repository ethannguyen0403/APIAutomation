...
public class APIUtils {
    ...
    public static Response get(String path) {
        ...
        Response response =
                given(SpecUtils.getRequestSpecBuilder()).
                        when().
                        get(path).
                        then().
                        spec(SpecUtils.getResponseSpecBuilder()).
                        extract().
                        response();
    ...
    public static Response get(String path, Map<String, String> headers) {
        ...
        Response response =
                given(SpecUtils.getRequestSpecBuilder().headers(headers)).
                        when().
                        get(path).
                        then().
                        spec(SpecUtils.getResponseSpecBuilder()).
    ...
    public static Response get(String path, String authBearerToken) {
        ...
        Response response =
                given(SpecUtils.getRequestSpecBuilder().header("Authorization", "Bearer " + authBearerToken)).
                        when().
                        get(path).
                        then().
                        spec(SpecUtils.getResponseSpecBuilder()).
    ...
    public static Response getNotAuth(String path) {
        ...
        Response response =
                given(SpecUtils.getRequestNotAuthSpecBuilder()).
                        when().
                        get(path).
                        then().
                        spec(SpecUtils.getResponseSpecBuilder()).
